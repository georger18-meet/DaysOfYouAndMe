	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 break26_g1368 = uv_BaseMap;
				...
				float4 tex2DNode7_g1367 = tex2D( _BaseMap, ( ( appendResult14_g1368 + appendResult13_g1368 ) + Layer0Parallax215 ) );
				float4 lerpResult53_g1367 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g1367 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g1367 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1367 = lerpResult53_g1367.rgb;
				float desaturateDot29_g1367 = dot( desaturateInitialColor29_g1367, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g1367 = lerp( desaturateInitialColor29_g1367, desaturateDot29_g1367.xxx, -clampResult27_g1367 );
				float4 Layer0BaseColor179 = CalculateContrast(_Brightness,float4( desaturateVar29_g1367 , 0.0 ));
				...
				float2 break26_g1060 = uv_MetallicGlossMapMAHSL2;
				float2 appendResult14_g1060 = (float2(( break26_g1060.x * L2GlobalTilingX484 ) , ( break26_g1060.y * L2GlobalTilingY486 )));
				float2 appendResult13_g1060 = (float2(( break26_g1060.x + L2GlobalOffsetX483 ) , ( break26_g1060.y + L2GlobalOffsetY485 )));
				float4 tex2DNode3_g1059 = tex2D( _MetallicGlossMapMAHSL2, ( ( appendResult14_g1060 + appendResult13_g1060 ) + float2( 0,0 ) ) );
				float2 paralaxOffset38_g1059 = ParallaxOffset( tex2DNode3_g1059.b , _ParallaxL2 , ase_tanViewDir );
				float2 switchResult37_g1059 = (((ase_vface>0)?(paralaxOffset38_g1059):(0.0)));
				float2 Layer2Parallax462 = switchResult37_g1059;
				...
				float temp_output_21_0_g1371 = VertexB116;
				float temp_output_55_0_g1371 = ( _L2BlendAmount - 2.37 );
				float lerpResult47_g1371 = lerp( temp_output_55_0_g1371 , ( temp_output_55_0_g1371 - temp_output_55_0_g1371 ) , VertexG115);
				...
				float temp_output_56_0_g1371 = ( _L2BlendContrast - 1.5 );
				float clampResult11_g1371 = clamp( ( lerpResult47_g1371 + (( 1.0 + temp_output_56_0_g1371 ) + (lerpResult830 - 0.0) * (-temp_output_56_0_g1371 - ( 1.0 + temp_output_56_0_g1371 )) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
				float blendOpSrc18_g1371 = clampResult11_g1371;
				float blendOpDest18_g1371 = saturate( ( (-1.0 + (3.0 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) + (( 1.0 + -6.0 ) + (temp_output_21_0_g1371 - 0.0) * (6.0 - ( 1.0 + -6.0 )) / (1.0 - 0.0)) ) );
				float blendOpSrc31_g1371 = (( _L2ConstrainbyPaintedMask )?( ( saturate( ( blendOpSrc18_g1371 * blendOpDest18_g1371 ) )) ):( clampResult11_g1371 ));
				float blendOpDest31_g1371 = temp_output_21_0_g1371;
				float VertexBHeightmap652 = ( (( _L2UseHeightmapDepth1 )?( ( saturate( ( blendOpSrc31_g1371 + blendOpDest31_g1371 ) )) ):( temp_output_21_0_g1371 )) * _L2BlendOpacity );
				...
				float temp_output_21_0_g1372 = VertexA117;
				float temp_output_61_0_g1372 = ( _L3BlendAmount - 2.37 );
				float lerpResult50_g1372 = lerp( temp_output_61_0_g1372 , ( temp_output_61_0_g1372 - 2.0 ) , VertexG115);
				float lerpResult55_g1372 = lerp( lerpResult50_g1372 , -1.0 , VertexB116);
				float lerpResult876 = lerp( ( Layer0Heightmap336 * ( 1.0 - VertexG115 ) ) , Layer1Heightmap510 , VertexG115);
				float Layer2Heightmap511 = tex2DNode3_g1059.b;
				float lerpResult819 = lerp( ( lerpResult876 * ( 1.0 - VertexB116 ) ) , Layer2Heightmap511 , VertexB116);
				float temp_output_63_0_g1372 = ( _L3BlendContrast - 1.5 );
				float clampResult11_g1372 = clamp( ( lerpResult55_g1372 + (( 1.0 + temp_output_63_0_g1372 ) + (lerpResult819 - 0.0) * (-temp_output_63_0_g1372 - ( 1.0 + temp_output_63_0_g1372 )) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
				float blendOpSrc18_g1372 = clampResult11_g1372;
				float blendOpDest18_g1372 = saturate( ( (-1.0 + (3.0 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) + (( 1.0 + -6.0 ) + (temp_output_21_0_g1372 - 0.0) * (6.0 - ( 1.0 + -6.0 )) / (1.0 - 0.0)) ) );
				float blendOpSrc31_g1372 = (( _L3ConstrainbyPaintedMask )?( ( saturate( ( blendOpSrc18_g1372 * blendOpDest18_g1372 ) )) ):( clampResult11_g1372 ));
				float blendOpDest31_g1372 = temp_output_21_0_g1372;
				float temp_output_978_0 = (( _L3UseHeightmapDepth1 )?( ( saturate( ( blendOpSrc31_g1372 + blendOpDest31_g1372 ) )) ):( temp_output_21_0_g1372 ));
				float VertexAHeightmap799 = temp_output_978_0;
				...
				float2 break26_g1370 = uv_BumpMap;
				float2 appendResult14_g1370 = (float2(( break26_g1370.x * L0GlobalTilingX150 ) , ( break26_g1370.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1370 = (float2(( break26_g1370.x + L0GlobalOffsetX151 ) , ( break26_g1370.y + L0GlobalOffsetY148 )));
				float3 unpack4_g1369 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g1370 + appendResult13_g1370 ) + Layer0Parallax215 ) ), _BumpScale );
				unpack4_g1369.z = lerp( 1, unpack4_g1369.z, saturate(_BumpScale) );
				float3 tex2DNode4_g1369 = unpack4_g1369;
				float3 Layer0Normal193 = tex2DNode4_g1369;
				...
				float Layer2Metallic478 = ( tex2DNode3_g1059.r * _MetallicL2 );
				...
				float Layer0Smoothness210 = temp_output_1_0_g1055;
				...
				float temp_output_1_0_g1059 = ( tex2DNode3_g1059.a * _GlossinessL2 );
				float Layer2Smoothness480 = temp_output_1_0_g1059;
				...
				float blendOpSrc34_g1059 = tex2DNode3_g1059.g;
				float blendOpDest34_g1059 = ( 1.0 - _AoIntensityL2 );
				float Layer2Ao479 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc34_g1059 ) * ( 1.0 - blendOpDest34_g1059 ) ) ));
				...
				float3 BaseColor = BaseColor121.rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 lerpResult100 = lerp( lerpResult99 , Layer2BaseColor476 , VertexBHeightmap652);
				float4 temp_cast_6 = (1.0).xxxx;
				float2 uv_WetTex = IN.ase_texcoord4.xy * _WetTex_ST.xy + _WetTex_ST.zw;
				float4 tex2DNode727 = tex2D( _WetTex, uv_WetTex );
				#if defined(_WETBASECOLOR_COLOR)
				float4 staticSwitch767 = temp_cast_6;
				#elif defined(_WETBASECOLOR_WETMAP)
