	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 temp_output_8_0_g1435 = CalculateContrast(_L0Heightmapcontrast,( temp_cast_1 + (-0.5 + (_L0HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer0VertexOffset977 = ( float4( ( v.normalOS * ( _L0Displacement / 10.0 ) ) , 0.0 ) * temp_output_8_0_g1435 );
				...
				float4 temp_output_8_0_g1434 = CalculateContrast(_L1Heightmapcontrast,( temp_cast_4 + (-0.5 + (_L1HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer1VertexOffset1010 = ( float4( ( v.normalOS * ( _L1Displacement / 10.0 ) ) , 0.0 ) * temp_output_8_0_g1434 );
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float4 lerpResult53_g1419 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g1419 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g1419 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1419 = lerpResult53_g1419.rgb;
				...
				float2 break26_g1433 = uv_BaseColorL1;
				float L1GlobalTilingX234 = ( _GlobalXYTilingXYZWOffsetXYL1.x - 1.0 );
				float L1GlobalTilingY235 = ( _GlobalXYTilingXYZWOffsetXYL1.y - 1.0 );
				float2 appendResult14_g1433 = (float2(( break26_g1433.x * L1GlobalTilingX234 ) , ( break26_g1433.y * L1GlobalTilingY235 )));
				float L1GlobalOffsetX236 = _GlobalXYTilingXYZWOffsetXYL1.z;
				float L1GlobalOffsetY237 = _GlobalXYTilingXYZWOffsetXYL1.w;
				float2 appendResult13_g1433 = (float2(( break26_g1433.x + L1GlobalOffsetX236 ) , ( break26_g1433.y + L1GlobalOffsetY237 )));
				...
				float4 tex2DNode7_g1432 = tex2D( _BaseColorL1, ( ( appendResult14_g1433 + appendResult13_g1433 ) + Layer1Parallax247 ) );
				float clampResult27_g1432 = clamp( _SaturationL1 , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1432 = ( _ColorL1 * tex2DNode7_g1432 ).rgb;
				float desaturateDot29_g1432 = dot( desaturateInitialColor29_g1432, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g1432 = lerp( desaturateInitialColor29_g1432, desaturateDot29_g1432.xxx, -clampResult27_g1432 );
				float4 Layer1BaseColor261 = CalculateContrast(_BrightnessL1,float4( desaturateVar29_g1432 , 0.0 ));
				...
				float4 temp_output_8_0_g1435 = CalculateContrast(_L0Heightmapcontrast,( temp_cast_4 + (-0.5 + (_L0HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer0VisHeightmap978 = temp_output_8_0_g1435;
				float VertexR114 = break106.r;
				float Layer1Heightmap510 = tex2DNode3_g1058.b;
				float4 temp_cast_6 = (Layer1Heightmap510).xxxx;
				float4 temp_output_8_0_g1434 = CalculateContrast(_L1Heightmapcontrast,( temp_cast_6 + (-0.5 + (_L1HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer1VisHeightmap1011 = temp_output_8_0_g1434;
				
				float2 uv_BumpMap = IN.ase_texcoord8.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float2 break26_g1440 = uv_BumpMap;
				float2 appendResult14_g1440 = (float2(( break26_g1440.x * L0GlobalTilingX150 ) , ( break26_g1440.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1440 = (float2(( break26_g1440.x + L0GlobalOffsetX151 ) , ( break26_g1440.y + L0GlobalOffsetY148 )));
				float3 unpack4_g1439 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g1440 + appendResult13_g1440 ) + Layer0Parallax215 ) ), _BumpScale );
				unpack4_g1439.z = lerp( 1, unpack4_g1439.z, saturate(_BumpScale) );
				float3 tex2DNode4_g1439 = unpack4_g1439;
				float3 Layer0Normal193 = tex2DNode4_g1439;
				float2 uv_BumpMapL1 = IN.ase_texcoord8.xy * _BumpMapL1_ST.xy + _BumpMapL1_ST.zw;
				float2 break26_g1442 = uv_BumpMapL1;
				float2 appendResult14_g1442 = (float2(( break26_g1442.x * L1GlobalTilingX234 ) , ( break26_g1442.y * L1GlobalTilingY235 )));
				float2 appendResult13_g1442 = (float2(( break26_g1442.x + L1GlobalOffsetX236 ) , ( break26_g1442.y + L1GlobalOffsetY237 )));
				float3 unpack4_g1441 = UnpackNormalScale( tex2D( _BumpMapL1, ( ( appendResult14_g1442 + appendResult13_g1442 ) + Layer1Parallax247 ) ), _BumpScaleL1 );
				unpack4_g1441.z = lerp( 1, unpack4_g1441.z, saturate(_BumpScaleL1) );
				float3 tex2DNode4_g1441 = unpack4_g1441;
				float3 Layer1Normal260 = tex2DNode4_g1441;
				...
				float2 break26_g1437 = uv_EmissionMap;
				float2 appendResult14_g1437 = (float2(( break26_g1437.x * L0GlobalTilingX150 ) , ( break26_g1437.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1437 = (float2(( break26_g1437.x + L0GlobalOffsetX151 ) , ( break26_g1437.y + L0GlobalOffsetY148 )));
				float4 temp_output_5_0_g1436 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g1437 + appendResult13_g1437 ) + Layer1Parallax247 ) ) );
				float4 Layer0Emission1034 = ( temp_output_5_0_g1436 * _EmissionIntensity );
				float4 temp_cast_9 = (0.0).xxxx;
				float4 lerpResult1022 = lerp( Layer0Emission1034 , temp_cast_9 , VertexGHeightmap352);
				float4 Layer0EmissionRGB1039 = temp_output_5_0_g1436;
				...
				float3 BaseColor = (( _L1VisualizeHeightmap1 )?( ( Layer1VisHeightmap1011 * VertexG115 ) ):( (( _L0VisualizeHeightmap1 )?( ( Layer0VisHeightmap978 * VertexR114 ) ):( BaseColor121 )) )).rgb;
