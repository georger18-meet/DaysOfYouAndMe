	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 texCoord106_g1537 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 break26_g1552 = uv_BumpMapL2;
				float2 appendResult14_g1552 = (float2(( break26_g1552.x * L2GlobalTilingX484 ) , ( break26_g1552.y * L2GlobalTilingY486 )));
				float2 appendResult13_g1552 = (float2(( break26_g1552.x + L2GlobalOffsetX483 ) , ( break26_g1552.y + L2GlobalOffsetY485 )));
				float3 unpack4_g1551 = UnpackNormalScale( tex2D( _BumpMapL2, ( ( appendResult14_g1552 + appendResult13_g1552 ) + Layer2Parallax1055 ) ), _BumpScaleL2 );
				unpack4_g1551.z = lerp( 1, unpack4_g1551.z, saturate(_BumpScaleL2) );
				float3 tex2DNode4_g1551 = unpack4_g1551;
				float3 Layer2Normal1062 = tex2DNode4_g1551;
				...
				float2 break26_g1554 = uv_EmissionMap;
				float2 appendResult14_g1554 = (float2(( break26_g1554.x * L0GlobalTilingX150 ) , ( break26_g1554.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1554 = (float2(( break26_g1554.x + L0GlobalOffsetX151 ) , ( break26_g1554.y + L0GlobalOffsetY148 )));
				float4 temp_output_5_0_g1553 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g1554 + appendResult13_g1554 ) + Layer0Parallax215 ) ) );
				float4 Layer0Emission984 = ( temp_output_5_0_g1553 * _EmissionIntensity );
				...
				float lerpResult169_g1537 = lerp( ( temp_output_153_0_g1537 * ase_lightColor.a ) , ( temp_output_153_0_g1537 * ( ase_lightAtten * ase_lightColor.a ) ) , _ShadowMask);
				...
				float4 Layer0EmissionRGB1086 = temp_output_5_0_g1553;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 lerpResult99 = lerp( Layer0BaseColor179 , Layer2BaseColor1070 , VertexBHeightmap1077);
				float4 BaseColor121 = lerpResult99;
				float2 texCoord106_g1537 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult149_g1537 = clamp( _TilingInstance , 0.0 , 1000.0 );
				float2 temp_output_175_0_g1537 = Layer2Parallax1055;
				float temp_output_123_0_g1537 = ( tex2D( _SparkleMask, ( ( ( texCoord106_g1537 * _TilingDotMask ) * clampResult149_g1537 ) + temp_output_175_0_g1537 ) ).a + (-1.2 + (_SpreadDotMask - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) );
				float saferPower230_g1537 = abs( temp_output_123_0_g1537 );
