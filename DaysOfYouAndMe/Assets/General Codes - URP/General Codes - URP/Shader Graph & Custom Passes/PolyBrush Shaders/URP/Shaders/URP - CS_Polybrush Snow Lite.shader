Shader "Ciconia Studio/CS_Polybrush/URP/Lite/Snow"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			inline float4 TriplanarSampling274_g1553( sampler2D topTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 temp_output_8_0_g1551 = CalculateContrast(_L0Heightmapcontrast,( temp_cast_1 + (-0.5 + (_L0HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer0VertexOffset1124 = ( float4( ( v.normalOS * ( _L0Displacement / 10.0 ) ) , 0.0 ) * temp_output_8_0_g1551 );
				...
				float4 temp_output_8_0_g1552 = CalculateContrast(_L2Heightmapcontrast,( temp_cast_4 + (-0.5 + (_L2HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer2VertexOffset1144 = ( float4( ( v.normalOS * ( _L2Displacement / 10.0 ) ) , 0.0 ) * temp_output_8_0_g1552 );
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 break26_g1549 = uv_BaseMap;
				float L0GlobalTilingX150 = ( _GlobalXYTilingXYZWOffsetXY.x - 1.0 );
				float L0GlobalTilingY149 = ( _GlobalXYTilingXYZWOffsetXY.y - 1.0 );
				float2 appendResult14_g1549 = (float2(( break26_g1549.x * L0GlobalTilingX150 ) , ( break26_g1549.y * L0GlobalTilingY149 )));
				float L0GlobalOffsetX151 = _GlobalXYTilingXYZWOffsetXY.z;
				float L0GlobalOffsetY148 = _GlobalXYTilingXYZWOffsetXY.w;
				float2 appendResult13_g1549 = (float2(( break26_g1549.x + L0GlobalOffsetX151 ) , ( break26_g1549.y + L0GlobalOffsetY148 )));
				...
				float4 tex2DNode7_g1548 = tex2D( _BaseMap, ( ( appendResult14_g1549 + appendResult13_g1549 ) + Layer0Parallax215 ) );
				float4 lerpResult53_g1548 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g1548 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g1548 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1548 = lerpResult53_g1548.rgb;
				float desaturateDot29_g1548 = dot( desaturateInitialColor29_g1548, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g1548 = lerp( desaturateInitialColor29_g1548, desaturateDot29_g1548.xxx, -clampResult27_g1548 );
				float4 Layer0BaseColor179 = CalculateContrast(_Brightness,float4( desaturateVar29_g1548 , 0.0 ));
				...
				float VertexB116 = break106.b;
				float temp_output_21_0_g1550 = VertexB116;
				float Layer0Heightmap336 = tex2DNode3_g1501.b;
				float clampResult11_g1550 = clamp( ( (-4.0 + (_L2BlendAmount - 0.0) * (1.0 - -4.0) / (1.0 - 0.0)) + (( 1.0 + _L2BlendContrast ) + (Layer0Heightmap336 - 0.0) * (-_L2BlendContrast - ( 1.0 + _L2BlendContrast )) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
				float blendOpSrc18_g1550 = clampResult11_g1550;
				float blendOpDest18_g1550 = saturate( ( (-1.0 + (3.0 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) + (( 1.0 + -6.0 ) + (temp_output_21_0_g1550 - 0.0) * (6.0 - ( 1.0 + -6.0 )) / (1.0 - 0.0)) ) );
				float blendOpSrc31_g1550 = (( _L2ConstrainbyPaintedMask )?( ( saturate( ( blendOpSrc18_g1550 * blendOpDest18_g1550 ) )) ):( clampResult11_g1550 ));
				float blendOpDest31_g1550 = temp_output_21_0_g1550;
				float VertexBHeightmap1077 = ( (( _L2UseHeightmapDepth1 )?( ( saturate( ( blendOpSrc31_g1550 + blendOpDest31_g1550 ) )) ):( temp_output_21_0_g1550 )) * _L2BlendOpacity );
				...
				float4 temp_output_8_0_g1551 = CalculateContrast(_L0Heightmapcontrast,( temp_cast_4 + (-0.5 + (_L0HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer0VisHeightmap1125 = temp_output_8_0_g1551;
				float VertexR114 = break106.r;
				float Layer2Heightmap1053 = tex2DNode3_g1503.b;
				float4 temp_cast_6 = (Layer2Heightmap1053).xxxx;
				float4 temp_output_8_0_g1552 = CalculateContrast(_L2Heightmapcontrast,( temp_cast_6 + (-0.5 + (_L2HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer2VisHeightmap1145 = temp_output_8_0_g1552;
				float VertexG115 = break106.g;
				float2 texCoord106_g1553 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult149_g1553 = clamp( _TilingInstance , 0.0 , 1000.0 );
				float2 temp_output_175_0_g1553 = Layer2Parallax1055;
				float temp_output_123_0_g1553 = ( tex2D( _SparkleMask, ( ( ( texCoord106_g1553 * _TilingDotMask ) * clampResult149_g1553 ) + temp_output_175_0_g1553 ) ).a + (-1.2 + (_SpreadDotMask - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) );
				float saferPower230_g1553 = abs( temp_output_123_0_g1553 );
				float temp_output_121_0_g1553 = ( _ContrastDotMask + 1.0 );
				float clampResult118_g1553 = clamp( pow( saferPower230_g1553 , temp_output_121_0_g1553 ) , 0.0 , 1.0 );
				float clampResult240_g1553 = clamp( _SparklePower , 0.0 , 100000.0 );
				float temp_output_277_0_g1553 = ( ( clampResult118_g1553 * _IntensityDotMask ) * clampResult240_g1553 );
				float VisualizeDotMap1001 = temp_output_277_0_g1553;
				float4 temp_cast_8 = (VisualizeDotMap1001).xxxx;
				float temp_output_135_0_g1553 = ( _ContrastSparkles - -1.0 );
				float2 temp_cast_9 = (( ( _TilingCrystals / 10.0 ) * clampResult149_g1553 )).xx;
				float3 worldToObj273_g1553 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float4 triplanar274_g1553 = TriplanarSampling274_g1553( _SparkleMask, ( ( ( worldToObj273_g1553 / 4.0 ) - WorldViewDirection ) + float3( temp_output_175_0_g1553 ,  0.0 ) ), WorldNormal, 1.0, temp_cast_9, 1.0, 0 );
				float clampResult49_g1553 = clamp( _Desaturatecrystals , 0.0 , 1.0 );
				float3 desaturateInitialColor53_g1553 = triplanar274_g1553.xyz;
				float desaturateDot53_g1553 = dot( desaturateInitialColor53_g1553, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar53_g1553 = lerp( desaturateInitialColor53_g1553, desaturateDot53_g1553.xxx, clampResult49_g1553 );
				float lerpResult246_g1553 = lerp( 0.6 , 1.0 , _AmountSparkle);
				float4 clampResult74_g1553 = clamp( ( saturate( ( CalculateContrast(temp_output_135_0_g1553,float4( desaturateVar53_g1553 , 0.0 )) + (( -1.0 - temp_output_135_0_g1553 ) + (lerpResult246_g1553 - 0.0) * (0.0 - ( -1.0 - temp_output_135_0_g1553 )) / (1.0 - 0.0)) ) ) * _CrystalsIntensity ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 VisualizeSparklesMap1002 = clampResult74_g1553;
				...
				float2 break26_g1566 = uv_BumpMap;
				float2 appendResult14_g1566 = (float2(( break26_g1566.x * L0GlobalTilingX150 ) , ( break26_g1566.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1566 = (float2(( break26_g1566.x + L0GlobalOffsetX151 ) , ( break26_g1566.y + L0GlobalOffsetY148 )));
				float3 unpack4_g1565 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g1566 + appendResult13_g1566 ) + Layer0Parallax215 ) ), _BumpScale );
				unpack4_g1565.z = lerp( 1, unpack4_g1565.z, saturate(_BumpScale) );
				float3 tex2DNode4_g1565 = unpack4_g1565;
				float3 Layer0Normal193 = tex2DNode4_g1565;
				float2 uv_BumpMapL2 = IN.ase_texcoord8.xy * _BumpMapL2_ST.xy + _BumpMapL2_ST.zw;
				float2 break26_g1564 = uv_BumpMapL2;
				float2 appendResult14_g1564 = (float2(( break26_g1564.x * L2GlobalTilingX484 ) , ( break26_g1564.y * L2GlobalTilingY486 )));
				float2 appendResult13_g1564 = (float2(( break26_g1564.x + L2GlobalOffsetX483 ) , ( break26_g1564.y + L2GlobalOffsetY485 )));
				float3 unpack4_g1563 = UnpackNormalScale( tex2D( _BumpMapL2, ( ( appendResult14_g1564 + appendResult13_g1564 ) + Layer2Parallax1055 ) ), _BumpScaleL2 );
				unpack4_g1563.z = lerp( 1, unpack4_g1563.z, saturate(_BumpScaleL2) );
				float3 tex2DNode4_g1563 = unpack4_g1563;
				float3 Layer2Normal1062 = tex2DNode4_g1563;
				...
				float2 break26_g1562 = uv_EmissionMap;
				float2 appendResult14_g1562 = (float2(( break26_g1562.x * L0GlobalTilingX150 ) , ( break26_g1562.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1562 = (float2(( break26_g1562.x + L0GlobalOffsetX151 ) , ( break26_g1562.y + L0GlobalOffsetY148 )));
				float4 temp_output_5_0_g1561 = ( _EmissionColor * tex2D( _EmissionMap, ( ( appendResult14_g1562 + appendResult13_g1562 ) + Layer0Parallax215 ) ) );
				float4 Layer0Emission984 = ( temp_output_5_0_g1561 * _EmissionIntensity );
				float4 temp_cast_14 = (0.0).xxxx;
				float4 lerpResult1118 = lerp( Layer0Emission984 , temp_cast_14 , VertexBHeightmap1077);
				float4 temp_output_108_0_g1553 = ( clampResult74_g1553 * temp_output_277_0_g1553 );
				...
				float dotResult152_g1553 = dot( WorldNormal , SafeNormalize(_MainLightPosition.xyz) );
				float temp_output_153_0_g1553 = max( dotResult152_g1553 , 0.0 );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float lerpResult169_g1553 = lerp( ( temp_output_153_0_g1553 * ase_lightColor.a ) , ( temp_output_153_0_g1553 * ( ase_lightAtten * ase_lightColor.a ) ) , _ShadowMask);
				float4 temp_output_165_0_g1553 = ( (( _AoMask )?( ( temp_output_108_0_g1553 * temp_cast_15 ) ):( temp_output_108_0_g1553 )) * lerpResult169_g1553 );
				float4 temp_output_1160_0 = temp_output_165_0_g1553;
				...
				float4 Layer0EmissionRGB1086 = temp_output_5_0_g1561;
				...
				float3 BaseColor = staticSwitch1013.rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 Layer2VisHeightmap1145 = temp_output_8_0_g1552;
				float VertexG115 = break106.g;
				float2 texCoord106_g1553 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult149_g1553 = clamp( _TilingInstance , 0.0 , 1000.0 );
				float2 temp_output_175_0_g1553 = Layer2Parallax1055;
				float temp_output_123_0_g1553 = ( tex2D( _SparkleMask, ( ( ( texCoord106_g1553 * _TilingDotMask ) * clampResult149_g1553 ) + temp_output_175_0_g1553 ) ).a + (-1.2 + (_SpreadDotMask - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) );
				float saferPower230_g1553 = abs( temp_output_123_0_g1553 );
				...
				float2 temp_cast_9 = (( ( _TilingCrystals / 10.0 ) * clampResult149_g1553 )).xx;
				float3 worldToObj273_g1553 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float4 triplanar274_g1553 = TriplanarSampling274_g1553( _SparkleMask, ( ( ( worldToObj273_g1553 / 4.0 ) - ase_worldViewDir ) + float3( temp_output_175_0_g1553 ,  0.0 ) ), ase_worldNormal, 1.0, temp_cast_9, 1.0, 0 );
				float clampResult49_g1553 = clamp( _Desaturatecrystals , 0.0 , 1.0 );
				float3 desaturateInitialColor53_g1553 = triplanar274_g1553.xyz;
				float desaturateDot53_g1553 = dot( desaturateInitialColor53_g1553, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar53_g1553 = lerp( desaturateInitialColor53_g1553, desaturateDot53_g1553.xxx, clampResult49_g1553 );
				...
				float Layer2Ao1071 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc34_g1503 ) * ( 1.0 - blendOpDest34_g1503 ) ) ));
				float4 temp_cast_15 = (Layer2Ao1071).xxxx;
				float dotResult152_g1553 = dot( ase_worldNormal , SafeNormalize(_MainLightPosition.xyz) );
				float temp_output_153_0_g1553 = max( dotResult152_g1553 , 0.0 );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float ase_lightAtten = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 Layer2VisHeightmap1145 = temp_output_8_0_g1552;
				float VertexG115 = break106.g;
				float2 texCoord106_g1553 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult149_g1553 = clamp( _TilingInstance , 0.0 , 1000.0 );
				float2 temp_output_175_0_g1553 = Layer2Parallax1055;
				float temp_output_123_0_g1553 = ( tex2D( _SparkleMask, ( ( ( texCoord106_g1553 * _TilingDotMask ) * clampResult149_g1553 ) + temp_output_175_0_g1553 ) ).a + (-1.2 + (_SpreadDotMask - 0.0) * (0.7 - -1.2) / (1.0 - 0.0)) );
				float saferPower230_g1553 = abs( temp_output_123_0_g1553 );
