	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 Layer0VertexOffset605 = ( float4( ( v.normalOS * ( _L0Displacement / 10.0 ) ) , 0.0 ) * temp_output_8_0_g1329 );
				...
				float4 temp_output_8_0_g1330 = CalculateContrast(_L1Heightmapcontrast,( temp_cast_4 + (-0.5 + (_L1HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer1VertexOffset613 = ( float4( ( v.normalOS * ( _L1Displacement / 10.0 ) ) , 0.0 ) * temp_output_8_0_g1330 );
				...
				float4 temp_output_8_0_g1331 = CalculateContrast(_L2Heightmapcontrast,( temp_cast_7 + (-0.5 + (_L2HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer2VertexOffset637 = ( float4( ( v.normalOS * ( _L2Displacement / 10.0 ) ) , 0.0 ) * temp_output_8_0_g1331 );
				...
				float4 Layer3VertexOffset869 = ( float4( ( v.normalOS * ( _L1Displacement1 / 10.0 ) ) , 0.0 ) * temp_output_10_0_g1360 );
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 break26_g1381 = uv_BaseMap;
				float L0GlobalTilingX150 = ( _GlobalXYTilingXYZWOffsetXY.x - 1.0 );
				float L0GlobalTilingY149 = ( _GlobalXYTilingXYZWOffsetXY.y - 1.0 );
				...
				float4 tex2DNode7_g1380 = tex2D( _BaseMap, ( ( appendResult14_g1381 + appendResult13_g1381 ) + Layer0Parallax215 ) );
				float4 lerpResult53_g1380 = lerp( _BaseColor , ( ( _BaseColor * tex2DNode7_g1380 ) * _BaseColor.a ) , _BaseColor.a);
				float clampResult27_g1380 = clamp( _Saturation , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1380 = lerpResult53_g1380.rgb;
				float desaturateDot29_g1380 = dot( desaturateInitialColor29_g1380, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g1380 = lerp( desaturateInitialColor29_g1380, desaturateDot29_g1380.xxx, -clampResult27_g1380 );
				float4 Layer0BaseColor179 = CalculateContrast(_Brightness,float4( desaturateVar29_g1380 , 0.0 ));
				float2 uv_BaseColorL1 = IN.ase_texcoord8.xyz.xy * _BaseColorL1_ST.xy + _BaseColorL1_ST.zw;
				float2 break26_g1305 = uv_BaseColorL1;
				float L1GlobalTilingX234 = ( _GlobalXYTilingXYZWOffsetXYL1.x - 1.0 );
				float L1GlobalTilingY235 = ( _GlobalXYTilingXYZWOffsetXYL1.y - 1.0 );
				float2 appendResult14_g1305 = (float2(( break26_g1305.x * L1GlobalTilingX234 ) , ( break26_g1305.y * L1GlobalTilingY235 )));
				float L1GlobalOffsetX236 = _GlobalXYTilingXYZWOffsetXYL1.z;
				float L1GlobalOffsetY237 = _GlobalXYTilingXYZWOffsetXYL1.w;
				float2 appendResult13_g1305 = (float2(( break26_g1305.x + L1GlobalOffsetX236 ) , ( break26_g1305.y + L1GlobalOffsetY237 )));
				...
				float4 tex2DNode7_g1304 = tex2D( _BaseColorL1, ( ( appendResult14_g1305 + appendResult13_g1305 ) + Layer1Parallax247 ) );
				float clampResult27_g1304 = clamp( _SaturationL1 , -1.0 , 100.0 );
				float3 desaturateInitialColor29_g1304 = ( _ColorL1 * tex2DNode7_g1304 ).rgb;
				float desaturateDot29_g1304 = dot( desaturateInitialColor29_g1304, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar29_g1304 = lerp( desaturateInitialColor29_g1304, desaturateDot29_g1304.xxx, -clampResult27_g1304 );
				float4 Layer1BaseColor261 = CalculateContrast(_BrightnessL1,float4( desaturateVar29_g1304 , 0.0 ));
				float4 break106 = IN.ase_color;
				float VertexG115 = break106.g;
				float temp_output_21_0_g1306 = VertexG115;
				float Layer0Heightmap336 = tex2DNode3_g1058.b;
				float temp_output_49_0_g1306 = ( _L1BlendContrast - 1.5 );
				float clampResult11_g1306 = clamp( ( ( _L1BlendAmount - 2.37 ) + (( 1.0 + temp_output_49_0_g1306 ) + (Layer0Heightmap336 - 0.0) * (-temp_output_49_0_g1306 - ( 1.0 + temp_output_49_0_g1306 )) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
				...
				float blendOpSrc31_g1306 = (( _L1ConstrainbyPaintedMask )?( ( saturate( ( blendOpSrc18_g1306 * blendOpDest18_g1306 ) )) ):( clampResult11_g1306 ));
				float blendOpDest31_g1306 = temp_output_21_0_g1306;
				float VertexGHeightmap352 = ( (( _L1UseHeightmapDepth1 )?( ( saturate( ( blendOpSrc31_g1306 + blendOpDest31_g1306 ) )) ):( temp_output_21_0_g1306 )) * _L1BlendOpacity );
				...
				float VertexB116 = break106.b;
				float temp_output_21_0_g1307 = VertexB116;
				float temp_output_55_0_g1307 = ( _L2BlendAmount - 2.37 );
				float lerpResult47_g1307 = lerp( temp_output_55_0_g1307 , ( temp_output_55_0_g1307 - temp_output_55_0_g1307 ) , VertexG115);
				float Layer1Heightmap510 = tex2DNode3_g1060.b;
				float lerpResult830 = lerp( Layer0Heightmap336 , ( Layer1Heightmap510 * VertexG115 ) , VertexG115);
				float temp_output_56_0_g1307 = ( _L2BlendContrast - 1.5 );
				float clampResult11_g1307 = clamp( ( lerpResult47_g1307 + (( 1.0 + temp_output_56_0_g1307 ) + (lerpResult830 - 0.0) * (-temp_output_56_0_g1307 - ( 1.0 + temp_output_56_0_g1307 )) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
				float blendOpSrc18_g1307 = clampResult11_g1307;
				float blendOpDest18_g1307 = saturate( ( (-1.0 + (3.0 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) + (( 1.0 + -6.0 ) + (temp_output_21_0_g1307 - 0.0) * (6.0 - ( 1.0 + -6.0 )) / (1.0 - 0.0)) ) );
				float blendOpSrc31_g1307 = (( _L2ConstrainbyPaintedMask )?( ( saturate( ( blendOpSrc18_g1307 * blendOpDest18_g1307 ) )) ):( clampResult11_g1307 ));
				float blendOpDest31_g1307 = temp_output_21_0_g1307;
				float VertexBHeightmap652 = ( (( _L2UseHeightmapDepth1 )?( ( saturate( ( blendOpSrc31_g1307 + blendOpDest31_g1307 ) )) ):( temp_output_21_0_g1307 )) * _L2BlendOpacity );
				...
				float VertexA117 = break106.a;
				float temp_output_21_0_g1308 = VertexA117;
				float temp_output_61_0_g1308 = ( _L3BlendAmount - 2.37 );
				float lerpResult50_g1308 = lerp( temp_output_61_0_g1308 , ( temp_output_61_0_g1308 - 2.0 ) , VertexG115);
				float lerpResult55_g1308 = lerp( lerpResult50_g1308 , -1.0 , VertexB116);
				...
				float temp_output_63_0_g1308 = ( _L3BlendContrast - 1.5 );
				float clampResult11_g1308 = clamp( ( lerpResult55_g1308 + (( 1.0 + temp_output_63_0_g1308 ) + (lerpResult819 - 0.0) * (-temp_output_63_0_g1308 - ( 1.0 + temp_output_63_0_g1308 )) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
				float blendOpSrc18_g1308 = clampResult11_g1308;
				float blendOpDest18_g1308 = saturate( ( (-1.0 + (3.0 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) + (( 1.0 + -6.0 ) + (temp_output_21_0_g1308 - 0.0) * (6.0 - ( 1.0 + -6.0 )) / (1.0 - 0.0)) ) );
				float blendOpSrc31_g1308 = (( _L3ConstrainbyPaintedMask )?( ( saturate( ( blendOpSrc18_g1308 * blendOpDest18_g1308 ) )) ):( clampResult11_g1308 ));
				float blendOpDest31_g1308 = temp_output_21_0_g1308;
				float temp_output_929_0 = (( _L3UseHeightmapDepth1 )?( ( saturate( ( blendOpSrc31_g1308 + blendOpDest31_g1308 ) )) ):( temp_output_21_0_g1308 ));
				...
				float4 temp_output_8_0_g1330 = CalculateContrast(_L1Heightmapcontrast,( temp_cast_9 + (-0.5 + (_L1HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer1VisHeightmap612 = temp_output_8_0_g1330;
				float4 temp_cast_11 = (Layer2Heightmap511).xxxx;
				float4 temp_output_8_0_g1331 = CalculateContrast(_L2Heightmapcontrast,( temp_cast_11 + (-0.5 + (_L2HeightmapSpread - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
				float4 Layer2VisHeightmap638 = temp_output_8_0_g1331;
				...
				float2 break26_g1383 = uv_BumpMap;
				...
				float3 unpack4_g1382 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult14_g1383 + appendResult13_g1383 ) + Layer0Parallax215 ) ), _BumpScale );
				unpack4_g1382.z = lerp( 1, unpack4_g1382.z, saturate(_BumpScale) );
				float3 tex2DNode4_g1382 = unpack4_g1382;
				float3 Layer0Normal193 = tex2DNode4_g1382;
				...
				float2 break26_g1378 = uv_BumpMapL2;
				float2 appendResult14_g1378 = (float2(( break26_g1378.x * L2GlobalTilingX484 ) , ( break26_g1378.y * L2GlobalTilingY486 )));
				float2 appendResult13_g1378 = (float2(( break26_g1378.x + L2GlobalOffsetX483 ) , ( break26_g1378.y + L2GlobalOffsetY485 )));
				float3 unpack4_g1377 = UnpackNormalScale( tex2D( _BumpMapL2, ( ( appendResult14_g1378 + appendResult13_g1378 ) + Layer2Parallax462 ) ), _BumpScaleL2 );
				unpack4_g1377.z = lerp( 1, unpack4_g1377.z, saturate(_BumpScaleL2) );
				float3 tex2DNode4_g1377 = unpack4_g1377;
				float3 Layer2Normal477 = tex2DNode4_g1377;
				...
				float cos54_g1376 = cos( radians( _RotationAngle1 ) );
				float sin54_g1376 = sin( radians( _RotationAngle1 ) );
				float2 rotator54_g1376 = mul( ( uv_PuddleMap * _TilingWave1 ) - float2( 0.5,0.5 ) , float2x2( cos54_g1376 , -sin54_g1376 , sin54_g1376 , cos54_g1376 )) + float2( 0.5,0.5 );
				float2 panner86_g1376 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_16 + rotator54_g1376);
				float3 unpack107_g1376 = UnpackNormalScale( tex2D( _PuddleMap, panner86_g1376 ), _NormalWaveIntensity1 );
				unpack107_g1376.z = lerp( 1, unpack107_g1376.z, saturate(_NormalWaveIntensity1) );
				#ifdef _MAINWAVE_ON
				float3 staticSwitch109_g1376 = unpack107_g1376;
				#else
				float3 staticSwitch109_g1376 = float3(0,0,1);
				#endif
				float2 temp_cast_17 = (_TranslationSpeed2).xx;
				float cos83_g1376 = cos( radians( _RotationAngle2 ) );
				float sin83_g1376 = sin( radians( _RotationAngle2 ) );
				float2 rotator83_g1376 = mul( ( uv_PuddleMap * _TilingWave2 ) - float2( 0.5,0.5 ) , float2x2( cos83_g1376 , -sin83_g1376 , sin83_g1376 , cos83_g1376 )) + float2( 0.5,0.5 );
				float2 panner88_g1376 = ( ( _TimeParameters.x * 0.05 ) * temp_cast_17 + rotator83_g1376);
				float3 unpack108_g1376 = UnpackNormalScale( tex2D( _PuddleMap, panner88_g1376 ), _NormalWaveIntensity2 );
				unpack108_g1376.z = lerp( 1, unpack108_g1376.z, saturate(_NormalWaveIntensity2) );
				#ifdef _DETAILWAVE_ON
				float3 staticSwitch56_g1376 = BlendNormal( staticSwitch109_g1376 , unpack108_g1376 );
				#else
				float3 staticSwitch56_g1376 = staticSwitch109_g1376;
				#endif
				float3 lerpResult128 = lerp( lerpResult127 , staticSwitch56_g1376 , ( VertexAHeightmap799 * WetOpacity768 ));
				float3 Normal129 = lerpResult128;
				
				float3 worldRefl28_g1379 = normalize( reflect( -WorldViewDirection, float3( dot( tanToWorld0, Normal129 ), dot( tanToWorld1, Normal129 ), dot( tanToWorld2, Normal129 ) ) ) );
				float4 texCUBENode27_g1379 = texCUBElod( _Cubemap, float4( worldRefl28_g1379, _BlurReflection) );
				float clampResult39_g1379 = clamp( _ReflectionIntensity , 0.0 , 100.0 );
				float4 temp_cast_18 = (1.0).xxxx;
				float4 lerpResult704 = lerp( ( BaseColor121 * 0.0 ) , ( ( texCUBENode27_g1379 * ( texCUBENode27_g1379.a * clampResult39_g1379 ) * _ColorCubemap1 ) * temp_cast_18 ) , VertexA117);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 lerpResult128 = lerp( lerpResult127 , staticSwitch56_g1376 , ( VertexAHeightmap799 * WetOpacity768 ));
				float3 Normal129 = lerpResult128;
				float3 worldRefl28_g1379 = normalize( reflect( -ase_worldViewDir, float3( dot( tanToWorld0, Normal129 ), dot( tanToWorld1, Normal129 ), dot( tanToWorld2, Normal129 ) ) ) );
				float4 texCUBENode27_g1379 = texCUBElod( _Cubemap, float4( worldRefl28_g1379, _BlurReflection) );
				float clampResult39_g1379 = clamp( _ReflectionIntensity , 0.0 , 100.0 );
				float4 temp_cast_18 = (1.0).xxxx;
				float4 lerpResult704 = lerp( ( BaseColor121 * 0.0 ) , ( ( texCUBENode27_g1379 * ( texCUBENode27_g1379.a * clampResult39_g1379 ) * _ColorCubemap1 ) * temp_cast_18 ) , VertexA117);
