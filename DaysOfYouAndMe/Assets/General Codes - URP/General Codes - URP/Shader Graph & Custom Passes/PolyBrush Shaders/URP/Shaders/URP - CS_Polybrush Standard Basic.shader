	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 break26_g1065 = uv_MetallicGlossMapMAHS;
				float2 appendResult14_g1065 = (float2(( break26_g1065.x * L0GlobalTilingX150 ) , ( break26_g1065.y * L0GlobalTilingY149 )));
				float2 appendResult13_g1065 = (float2(( break26_g1065.x + L0GlobalOffsetX151 ) , ( break26_g1065.y + L0GlobalOffsetY148 )));
				float4 tex2DNode3_g1064 = tex2D( _MetallicGlossMapMAHS, ( ( appendResult14_g1065 + appendResult13_g1065 ) + float2( 0,0 ) ) );
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 ase_tanViewDir =  tanToWorld0 * WorldViewDirection.x + tanToWorld1 * WorldViewDirection.y  + tanToWorld2 * WorldViewDirection.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 paralaxOffset38_g1064 = ParallaxOffset( tex2DNode3_g1064.b , _Parallax , ase_tanViewDir );
				float2 switchResult37_g1064 = (((ase_vface>0)?(paralaxOffset38_g1064):(0.0)));
				float2 Layer0Parallax215 = switchResult37_g1064;
				...
				float Layer0Heightmap336 = tex2DNode3_g1064.b;
				...
				float Layer0Metallic211 = ( tex2DNode3_g1064.r * _Metallic );
				...
				float temp_output_1_0_g1064 = ( tex2DNode3_g1064.a * _Glossiness );
				float Layer0Smoothness210 = temp_output_1_0_g1064;
				...
				float blendOpSrc34_g1064 = tex2DNode3_g1064.g;
				float blendOpDest34_g1064 = ( 1.0 - _AoIntensity );
				float Layer0Ao214 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc34_g1064 ) * ( 1.0 - blendOpDest34_g1064 ) ) ));
